...
const KELAS_OPTIONS = [
  "X-RPL", "X-MP", "X-AKL", "X-DKV", "X-BR", "X-AN",
  "XI-RPL", "XI-MP", "XI-AKL", "XI-DKV", "XI-BR", "XI-AN",
  "XII-RPL", "XII-MP", "XII-AKL", "XII-DKV", "XII-BR", "XII-AN", 
];

export default function RegisterPage({ onNavigateLogin, onRegisterSuccess, onLoginSuccess }) {
  ...
  async function handleGoogle() {
    ...
    try {
      ...
      // Daftar dengan Google tidak perlu verifikasi OTP terpisah
  ...
  return (
    <AuthLayout
      ...
      subtitle="Daftar dulu untuk mulai pesan makanan kantin."
    >
